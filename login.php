...
$title = (isset($_GET['p']) && $_GET['p'] == "seConnecter") ? 'Se connecter' : "S'inscrire";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="box-inscription">
                                ...
                                <form action="login.php?action=inscription" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="text-center fs-6 mt-3 compte">
                                    <a href="login.php?action=seConnecter">j'ai déjà compte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container vh-100 d-flex justify-content-center align-items-center">
                    <div class="row w-75 justify-content-center">
                        <div class="wrapper">
                            ...
                            <form action="login.php?action=connecter" method="POST" class="p-3 mt-3">
                            ...
                            <div class="text-center fs-6 mt-3">
                                <a href="#">Mot de passe oublié?</a> Ou <a href="login.php?action=SInscrire">Créer un compte</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php  } else if ((isset($_GET['action']) && $_GET['action'] == "inscription")) {
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["profil"])) {
                    ...
                    if (move_uploaded_file($_FILES["profil"]["tmp_name"], $target_file)) {
                        ...
                        $sql = "INSERT INTO users (profil_user, nom_user, prenom_user, genre_user, email_user, password_user, daten_user, role_user) VALUES (:profil, :nom, :prenom, :genre, :email, :password, :date, :role)";
                        $stmt = $db->prepare($sql);
